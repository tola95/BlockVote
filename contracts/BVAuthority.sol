...
import "./BVBulletinBoard.sol";

contract BVAuthority {

    int secret;
    int shareIndex;
    address testAdminAddress;
    BVAdministrator testAdmin;
    ...
    function Authority(address adminAddress) {
        ...
        testAdmin = BVAdministrator(testAdminAddress);
    ...
    function sendShare(address authority2Ad, address authority3Ad) {
        BVAuthority(authority2Ad).receiveShare(secret, shareIndex);
        BVAuthority(authority3Ad).receiveShare(secret, shareIndex);
    }
